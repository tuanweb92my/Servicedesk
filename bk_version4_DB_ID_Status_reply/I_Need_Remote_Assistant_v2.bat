...
del %computername%_%date:~4,2%-%date:~7,2%-%date:~10,4%.txt
...
echo \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2.bat >> %computername%_%date:~4,2%-%date:~7,2%-%date:~10,4%.txt

echo call \\vnhocapfs101\OTHERS\RemoteAssistant\Search_notassigned.bat %computername% > \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat

echo call \\vnhocapfs101\OTHERS\RemoteAssistant\Search_status.bat %computername% >> \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat


echo call \\vnhocapfs101\OTHERS\RemoteAssistant\Send_ack.bat %computername% %nolines% >> \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat

echo pause >> \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat

echo "\\vnhocapfs101\OTHERS\RemoteAssistant\SCCM Remote Control\CmRcViewer.exe" %computername% >> \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat

echo call \\vnhocapfs101\OTHERS\RemoteAssistant\Update_inc.bat %computername% %username% %nolines% >> \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat


echo \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2a.bat %computername% %nolines% > \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%_v2.bat
...
echo INC#000%nolines%,%computername% , %username% , %date:~4,2%-%date:~7,2%-%date:~10,4% ,%time%, , notassigned , new , >  \\vnhocapfs101\Apps\RemoteAssistant\VNLO_Incident_%computername%.csv
...
copy %var%\%computername%_%date:~4,2%-%date:~7,2%-%date:~10,4%_systeminfo.txt \\vnhocapfs101\Apps\RemoteAssistant\
