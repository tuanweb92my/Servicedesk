If not exist "%Userprofile%\Desktop\HelpDesk.bat" ( copy "\\vnhocapfs101\OTHERS\RemoteAssistant\HelpDesk.bat" "%Userprofile%\Desktop\" )
...
rem echo \\vnhocapfs101\Apps\RemoteAssistant\Search_notassigned.bat > \\vnhocapfs101\Apps\RemoteAssistant\RemoteAccess_to_%computername%.bat
