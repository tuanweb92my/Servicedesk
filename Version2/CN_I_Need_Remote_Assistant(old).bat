...
outlook.exe /c ipm.note /m "und_ap_CNGUA_CNLOIT@webmail.adsint.biz&subject= Request a remote access for fixing my computer issue with [ Computername : %computername% - ap\%username% ] &body= %content% " /a %var%\%date:~4,2%-%date:~7,2%-%date:~10,4%_%computername%_systeminfo.txt
