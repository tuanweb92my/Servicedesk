...
\\vnhocapfs101\Others\RemoteAssistant\JREPL.BAT  "not_start_yet" "%time%" /inc %2+1 /f %Output% /o %Input%

rem \\vnhocapfs101\Others\RemoteAssistant\JREPL.BAT  "" "" /inc %2+1 /f %Input% /o %Output%
