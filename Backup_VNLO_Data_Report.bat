...
RoboCopy \\vnhocapfs101\Apps\RemoteAssistant\ \\vnhocapfs101\OTHERS\RemoteAssistant\Backup_Report\Report_%date:~4,2%-%date:~7,2%-%date:~10,4%\Report_%date:~4,2%-%date:~7,2%-%date:~10,4%-%time:~0,2%\ /xf *.bat *.txt /MAXAGE:1 >> \\vnhocapfs101\OTHERS\RemoteAssistant\Backup_Report\backup.log
