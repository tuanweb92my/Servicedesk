...
rem "C:\Program Files (x86)\Microsoft Office\root\Office16\outlook.exe" /c ipm.note /m "DG-vietnam-hoc-IT@webmail.adsint.biz& subject= %username% is working on INC#000%2 on %computer1% &body= Hello all, I ( %username% ) is taking this request. Thanks " 
...
"C:\Program Files\Microsoft Office\root\Office16\outlook.exe" /c ipm.note /m "DG-vietnam-hoc-IT@webmail.adsint.biz& subject= %username% is working on INC#000%2 on %computer1% &body= Hello all, I ( %username% ) is taking this request. Thanks " 
