...
echo \\vnhocapfs101\OTHERS\RemoteAssistant\RemoteAccess_to_%computername%.bat >> %date:~4,2%-%date:~7,2%-%date:~10,4%_%computername%.txt

rem echo <a href="file://///vnhocapfs101/OTHERS/RemoteAssistant/RemoteAccess_to_%computername%.bat"> </a> >> %date:~4,2%-%date:~7,2%-%date:~10,4%_%computername%.txt

rem echo href="file://///vnhocapfs101/OTHERS/RemoteAssistant/RemoteAccess_to_%computername%.bat" >> %date:~4,2%-%date:~7,2%-%date:~10,4%_%computername%.txt


echo "\\vnhocapfs101\OTHERS\RemoteAssistant\SCCM Remote Control\CmRcViewer.exe" %computername% > \\vnhocapfs101\OTHERS\RemoteAssistant\RemoteAccess_to_%computername%.bat
